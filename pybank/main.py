...
f = open(project_file2write , "w")
f.write("Financial Analysis{}".format("\n"))
f.write("----------------------------{}".format("\n"))
f.write("Total Months: {}{}".format(month_count,"\n"))
f.write("Total: {}{}".format(sum(total_netamount_list),"\n"))
f.write("Average Change: {}{}".format(round(average_change,2),"\n"))" \n""\n"
f.write("Greatest Increase in Profits: {} (${}) {}".format(greatest_increase_date, greatest_increase_profits,"\n" ))
f.write("Greatest Decrease in Profits: {} (${})".format(greatest_decrease_date,greatest_decrease_losses))
f.close()